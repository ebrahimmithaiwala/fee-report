...
<h3><i class="fa fa-angle-right"></i> Add New Accountant</h3>
              <div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  
                      <form method="POST" action="AddAccountant" class="form-horizontal style-form">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="password" name="password" class="form-control" placeholder="Set Accountant Password">
                              </div>
                          </div>
                        ...
                        <div class="col-md-4">
                        <input type="submit" value="Add Accountant" class="btn btn-primary">
