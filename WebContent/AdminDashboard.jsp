          ...
          <section class="wrapper site-min-height2">
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-3 col-md-offset-2">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-7 text-right">
                                    <div><h4>Accountant</h4></div>
                                </div>
                            </div>
                        </div>
                        <a href="AddAccountant.jsp">
                            <div class="panel-footer">
                                <span class="pull-left"><h5>Add New Accountant</h5></span>
                    ...
                    <div class="panel panel-success">
                        ...
                        <a href="ViewAllAccountant.jsp">
                            <div class="panel-footer">
                                <span class="pull-left"><h5>View Accountant</h5></span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
              ...
              <div class="row mtbox">
                        ...
                        <a href="ViewAllStudents.jsp">
                            <div class="panel-footer">
                                <span class="pull-left"><h5>View All Student</h5></span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
