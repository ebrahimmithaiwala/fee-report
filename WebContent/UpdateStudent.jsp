...
<h3><i class="fa fa-angle-right"></i> Update Student</h3>
              <div class="row mt">
          		<div class="col-lg-12">
   ...
   %>
                      <form method="POST" action="EditStudent" class="form-horizontal style-form">
                  ...
                  <input type="hidden" name="rollno" value="<%=s.getRollno()%>">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  name="name" class="form-control" value="<%=s.getName()%>" placeholder="Accountant Name">
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="email" name="email" class="form-control" value="<%=s.getEmail()%>" placeholder="Email Id">
                              </div>
                          </div>
    ...
    <label class="radio-inline">
      ...
      Female
                          ...
                          <select name="course" class="form-control">
              			 ...
              			 <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Total Fees</label>
                              <div class="col-sm-10">
                                  <input type="number" name="fee" class="form-control" value="<%=s.getFee() %>" placeholder="Total Fees">
                              </div>
                          </div>
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Paid</label>
                              <div class="col-sm-10">
                                  <input type="number" name="paid" class="form-control" value="<%=s.getPaid() %>" placeholder="Total Fees">
                              </div>
                          </div>
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Due</label>
                              <div class="col-sm-10">
                                  <input type="number" name="due" class="form-control" value="<%=s.getDue() %>" placeholder="Due">
                              </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  name="contact" class="form-control" value="<%=s.getContact() %>" placeholder="Contact Number">
                              </div>
                          </div>
