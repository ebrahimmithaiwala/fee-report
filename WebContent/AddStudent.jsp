          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      ...
                      <a href="AccountantDashboard.jsp">
...
<h3><i class="fa fa-angle-right"></i> Add New Student</h3>
              <div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form method="POST" action="AddStudent" class="form-horizontal style-form">
      ...
      Female
                          ...
                          <select name="course" class="form-control">
              			 ...
              			 <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="number" name="fee" class="form-control" placeholder="Total Fees">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="number" name="paid" class="form-control" placeholder="Total Fees">
                              </div>
                          </div>
